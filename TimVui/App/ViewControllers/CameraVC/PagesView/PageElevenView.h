...
@interface PageElevenView : PageView
...
@property (unsafe_unretained, nonatomic) IBOutlet UIImageView *imgLike;
@property (unsafe_unretained, nonatomic) IBOutlet UILabel *lblLineTop;
@property (unsafe_unretained, nonatomic) IBOutlet UILabel *lblLineBottom;
@property (unsafe_unretained, nonatomic) IBOutlet UIImageView *imgClockIcon;
