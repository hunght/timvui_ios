...
@property (nonatomic, unsafe_unretained) IBOutlet id<LocationPickerViewDelegate> delegate;
...
@property (nonatomic, unsafe_unretained) IBOutlet id<UITableViewDataSource> tableViewDataSource;

/** This UITableViewDelegate is forwarded to the LocationPickers's
 UITableView when it is created. */
@property (nonatomic, unsafe_unretained ) IBOutlet id<UITableViewDelegate> tableViewDelegate;

/** This MKMapViewDelegate is forwarded to the LocationPickers's
 MKMapView when it is created. */
@property (nonatomic, unsafe_unretained) IBOutlet id<GMSMapViewDelegate> mapViewDelegate;
