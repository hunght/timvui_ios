...
@interface SearchCitiesVC () {
    BOOL _mayUsePrivateAPI;
}

@end

@implementation SearchCitiesVC
...
-(void)setDataForSearchTable{
    NSArray * arr=[SharedAppDelegate.getCityDistrictData valueForKey:@"data"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView != self.tableView){
        _searchVC.dicCitySearchParam=  [self.filteredPersons objectAtIndex:indexPath.row];
        _searchVC.dicDistrictSearchParam=nil;
    }else{
        _searchVC.dicCitySearchParam=  [[self.sections objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
        _searchVC.dicDistrictSearchParam=nil;
    }
